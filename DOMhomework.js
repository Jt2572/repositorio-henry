...
span.innerHTML='aplicacion creada por Jairo';
...
function addToDo() {
  // Tu código acá:
  var newToDo = new ToDo(document.querySelector('#toDoInput').value) 
  toDoItems.push(newToDo);
  document.getElementById('toDoInput').value='';
  // var newInput = document.getElementById('toDoInput').value
  // newInput.value = '';
  displayToDos();
